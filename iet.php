...
<?php
  ...
  // -p, -s and -f picker
    ...
    echo ('<div class="container">'."\n");
      echo ('<table style="width:100%;min-width:900px;table-layout:fixed">'."\n");
      echo ('<tr>'."\n");
      ...
      echo ('</tr>'."\n");
      echo ('<tr><td>'."\n");
        echo ('<input type="text" id="solvent" name="solvent" value="" style="width:100%" hidden />');
        echo ('</td><td>'."\n");
        echo ('<input type="text" id="solute" name="solute" value="" style="width:100%" hidden />');
        echo ('</td><td>'."\n");
  ...
  // basic options
    ...
    echo ('<center>');
    echo ('<div class="itembox"><center><b>Basic Options</b><br></center><hr><table>'."\n");
  ...
  // output
    ...
    echo ('<div class="itembox"><center><b>Output Settings</b><br></center><hr><table>'."\n");

        echo ('<tr><td>Log file</td><td> <input type="text" id="log" name="log" value="'.$set->log.'" placeholder="stdout.txt" /></td></tr>'."\n");

        echo ('<tr><td>&nbsp&#8226 report</td><td>'); echo ('<input type="text" id="report" name="report" value='.$set->report.' hidden />'."\n");
        ...
        echo ('<tr><td>&nbsp&#8226 save</td><td>'); echo ('<input type="text" id="save" name="save" value='.$set->save.' hidden />'."\n");
          ...
          //echo ('<br>');
        echo ("</td></tr>\n");
        echo ('<tr><td>&nbsp&#8226 save options</td><td>');
  ...
  // advanced options
    ...
    echo ('<div class="itembox"><center><b>Advanced Options</b><br></center><hr><table>'."\n");
